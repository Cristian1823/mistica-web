...
window.MISTICA_DATA = {
  bolsos: [
    ...
    },
    {
      id: "b02",
      name: "Onyx",
      sub: "Cosmetiquera · piel sintética",
      desc: "Cosmetiquera compacta con cierre dorado y espacio organizado para tus esenciales de belleza.",
      price: 23000,
    ...
    },
    {
      id: "b04",
      name: "Black Muse",
      sub: "Bolso clutch · piel sintética",
      desc: "Cartera elegante con detalle metálico. Perfecta para eventos y noches especiales. Incluye cadena removible.",
      price: 50000,
    ...
    },
    {
      id: "b05",
      name: "Vanta",
      sub: "Mochila urbana · piel sintética",
    ...
    },
    {
      id: "b06",
      name: "Velvet",
      sub: "Porta celular · piel sintética",
      desc: "Porta celular con correa ajustable. Práctico, cómodo y con estilo para llevar solo lo esencial.",
      price: 50000,
    ...
    },
    {
      ...
      name: "Selene",
      sub: "Bolso de mano · piel sintética",
      desc: "Diseño elegante y femenino, ideal para complementar cualquier look del día a día.",
      price: 55000,
      colors: [{name:"Negro", hex:"#1a1410"}, {name:"Camel", hex:"#b8895a"}, {name:"Rosa", hex:"#e8c9c1"}],
      sizes: ["Único"],
      img: "bolsos/selene.jpeg",
      ph: { bg:"#d9c7af", a:"#e8dfd0", b:"#9a6f43", shape:"bag-tote" }
    },
    {
      id: "b08",
      name: "Olivia",
